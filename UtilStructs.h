...
public:
	...
	Vector(int x, int y, int z) { this->x = static_cast<float>(x); this->y = static_cast<float>(y); this->z = static_cast<float>(z); }
...
public:
	...
	Quaternion(int x, int y, int z, int w) { this->w = static_cast<float>(w); this->x = static_cast<float>(x); this->y = static_cast<float>(y); this->z = static_cast<float>(z); }
...
public:
	...
	{
		this->maxX = static_cast<float>(maxX);
		this->minX = static_cast<float>(minX);
		this->maxY = static_cast<float>(maxY);
		this->minY = static_cast<float>(minY);
	}
