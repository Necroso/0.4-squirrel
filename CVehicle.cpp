...
void CVehicle::SetWorld(int world) {
    functions->SetVehicleWorld(this->nVehicleId, world);
}
void CVehicle::SetImmunity(int immunity) {
    functions->SetVehicleImmunityFlags(this->nVehicleId, immunity);
}
void CVehicle::SetPosition(Vector pos) {
    functions->SetVehiclePosition(this->nVehicleId, pos.x, pos.y, pos.z, 0);
}
...
void CVehicle::SetIdleRespawnTimer(unsigned int time) {
    functions->SetVehicleIdleRespawnTimer(this->nVehicleId, time);
}
void CVehicle::SetHealth(float health) {
    functions->SetVehicleHealth(this->nVehicleId, health);
}
...
void CVehicle::SetLocked(bool isLocked) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionDoorsLocked, isLocked);
}
void CVehicle::SetLightFlags(unsigned int flags) {
    functions->SetVehicleLightsData(this->nVehicleId, flags);
}
void CVehicle::SetDamage(unsigned int damage) {
    functions->SetVehicleDamageData(this->nVehicleId, damage);
}
void CVehicle::SetAlarm(bool isAlarmOn) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionAlarm, isAlarmOn);
}
void CVehicle::SetSiren(bool isSirenOn) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionSiren, isSirenOn);
}
void CVehicle::SetLights(bool lightsOn) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionLights, lightsOn);
}
void CVehicle::SetSingleUse(bool bSingleUse) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionSingleUse, bSingleUse);
}

int CVehicle::GetWorld() {
    return functions->GetVehicleWorld(this->nVehicleId);
}
int CVehicle::GetModel() {
    return functions->GetVehicleModel(this->nVehicleId);
}
int CVehicle::GetImmunity() {
    return functions->GetVehicleImmunityFlags(this->nVehicleId);
}
bool CVehicle::GetSingleUse(void) {
    return (functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionSingleUse) == 1 ? true : false);
}
...
unsigned int CVehicle::GetIdleRespawnTimer() {
    return functions->GetVehicleIdleRespawnTimer(this->nVehicleId);
}
float CVehicle::GetHealth() {
    return functions->GetVehicleHealth(this->nVehicleId);
}
...
bool CVehicle::GetLocked() {
    return (functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionDoorsLocked) == 1 ? true : false);
}
unsigned int CVehicle::GetDamage() {
    return functions->GetVehicleDamageData(this->nVehicleId);
}
unsigned int CVehicle::GetLightFlags(void) {
    return functions->GetVehicleLightsData(this->nVehicleId);
}
bool CVehicle::GetAlarm() {
    return (functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionAlarm) == 1 ? true : false);
}
bool CVehicle::GetSiren() {
    return (functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionSiren) == 1 ? true : false);
}
bool CVehicle::GetLights() {
    return (functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionLights) == 1 ? true : false);
}
...
void CVehicle::Respawn() {
    functions->RespawnVehicle(this->nVehicleId);
}
void CVehicle::Kill() {
    functions->ExplodeVehicle(this->nVehicleId);
}
int CVehicle::GetPartStatus(int part) {
    return functions->GetVehiclePartStatus(this->nVehicleId, part);
}
void CVehicle::SetPartStatus(int part, int status) {
    functions->SetVehiclePartStatus(this->nVehicleId, part, status);
}
int CVehicle::GetTyreStatus(int tyre) {
    return functions->GetVehicleTyreStatus(this->nVehicleId, tyre);
}
void CVehicle::SetTyreStatus(int tyre, int status) {
    functions->SetVehicleTyreStatus(this->nVehicleId, tyre, status);
}
int CVehicle::GetID() {
    return this->nVehicleId;
}

int CVehicle::GetSyncSource() {
    return functions->GetVehicleSyncSource(this->nVehicleId);
}
int CVehicle::GetSyncType() {
    return functions->GetVehicleSyncType(this->nVehicleId);
}
...
bool CVehicle::GetWrecked() {
    return (functions->IsVehicleWrecked(this->nVehicleId) == 1 ? true : false);
}
...
int CVehicle::SetHandlingData(int rule, float value) {
    return functions->SetInstHandlingRule(this->nVehicleId, rule, value);
}
double CVehicle::GetHandlingData(int rule) {
    return functions->GetInstHandlingRule(this->nVehicleId, rule);
}
void CVehicle::ResetHandlingData(int rule) {
    functions->ResetInstHandlingRule(this->nVehicleId, rule);
}
void CVehicle::ResetAllHandling() {
    functions->ResetInstHandling(this->nVehicleId);
}
bool CVehicle::IsHandlingSet(int rule) {
    return (functions->ExistsInstHandlingRule(this->nVehicleId, rule) == 1 ? true : false);
}
...
void CVehicle::SetRotation(Quaternion rotation) {
    functions->SetVehicleRotation(this->nVehicleId, rotation.x, rotation.y, rotation.z, rotation.w);
}
void CVehicle::SetEulerRotation(Vector rotation) {
    functions->SetVehicleRotationEuler(this->nVehicleId, rotation.x, rotation.y, rotation.z);
}
void CVehicle::SetSpeed(Vector speed) {
    functions->SetVehicleSpeed(this->nVehicleId, speed.x, speed.y, speed.z, false, false);
}
void CVehicle::SetRelativeSpeed(Vector speed) {
    functions->SetVehicleSpeed(this->nVehicleId, speed.x, speed.y, speed.z, false, true);
}
void CVehicle::SetTurnSpeed(Vector speed) {
    functions->SetVehicleTurnSpeed(this->nVehicleId, speed.x, speed.y, speed.z, false, false);
}
void CVehicle::SetRelativeTurnSpeed(Vector speed) {
    functions->SetVehicleTurnSpeed(this->nVehicleId, speed.x, speed.y, speed.z, false, true);
}
...
int CVehicle::GetRadio() {
    return functions->GetVehicleRadio(this->nVehicleId);
}
void CVehicle::SetRadio(const int nRadioId) {
    functions->SetVehicleRadio(this->nVehicleId, nRadioId);
}

bool CVehicle::GetRadioLockStatus() {
    return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionRadioLocked) == 1;
}
void CVehicle::SetRadioLocked(const bool isLocked) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionRadioLocked, isLocked);
}

bool CVehicle::GetGhost() {
    return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionGhost) == 1;
}
void CVehicle::SetGhost(const bool isGhost) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionGhost, isGhost);
}

// NEW FEATURES 0.4.7 ======================================================================================================
bool CVehicle::GetEngineEnabled() {
    return !functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionEngineDisabled);
}
void CVehicle::SetEngineEnabled(bool b) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionEngineDisabled, !b);
}

bool CVehicle::GetBonnetOpen() {
    return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionBonnetOpen);
}
void CVehicle::SetBonnetOpen(bool b) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionBonnetOpen, b);
}

bool CVehicle::GetBootOpen() {
    return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionBootOpen);
}
void CVehicle::SetBootOpen(bool b) {
    functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionBootOpen, b);
}

void CVehicle::Set3DArrowForPlayer(CPlayer* target, bool enable) {
    functions->SetVehicle3DArrowForPlayer(this->nVehicleId, target->nPlayerId, enable);
}

bool CVehicle::Get3DArrowForPlayer(CPlayer* target) {
    return functions->GetVehicle3DArrowForPlayer(this->nVehicleId, target->nPlayerId) == 1;
}
// =========================================================================================================================
void RegisterVehicle() {
    ...
    c
        ...
        .Prop(_SC("EngineEnabled"), &CVehicle::GetEngineEnabled, &CVehicle::SetEngineEnabled)
    ...
    c
        ...
        .Func(_SC("Get3DArrowForPlayer"), &CVehicle::Get3DArrowForPlayer)
        ...
        .Func(_SC("Set3DArrowForPlayer"), &CVehicle::Set3DArrowForPlayer)
