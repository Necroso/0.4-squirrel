...
// NEW FEATURES 0.4.7 ======================================================================================================
bool CVehicle::GetEngineEnabled() { return !functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionEngineDisabled); }
void CVehicle::SetEngineEnabled(bool b) { functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionEngineDisabled, !b); }

bool CVehicle::GetBonnetOpen() { return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionBonnetOpen); }
void CVehicle::SetBonnetOpen(bool b) { functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionBonnetOpen, b); }

bool CVehicle::GetBootOpen() { return functions->GetVehicleOption(this->nVehicleId, vcmpVehicleOptionBootOpen); }
void CVehicle::SetBootOpen(bool b) { functions->SetVehicleOption(this->nVehicleId, vcmpVehicleOptionBootOpen, b); }
