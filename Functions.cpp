...
void RegisterGlobals()
{
	...
	RootTable(v)
		...
		.Func(_SC("ClearWorldObjects"), &ClearWorldObjects, 1, _SC("i"))
		...
		.Func(_SC("SetVehicle3DArrowEnabled"), SetVehicle3DArrowEnabled, 3, _SC("tib"))
		.Func(_SC("GetVehicle3DArrowEnabled"), GetVehicle3DArrowEnabled, 2, _SC("ti"))
		...
		.Func(_SC("SetPlayer3DArrowEnabled"), SetPlayer3DArrowEnabled, 2, _SC("tb"))
		.Func(_SC("GetPlayer3DArrowEnabled"), GetPlayer3DArrowEnabled, 1, _SC("t"))
		.Func(_SC("GetNearbyEntities"), GetNearbyEntities, 3, _SC("t.f"))
		...
		.Func(_SC("GetCheckpointCount"), GetCheckpointCount, 1, _SC("t"))
		...
		.Func(_SC("FormatDecimal"), &FormatDecimal)
		.Func(_SC("ReplaceChars"), &ReplaceChars)
		...
		.Func(_SC("SetCrouchEnabled"), SetCrouchEnabled, 2, _SC("tb"))
		.Func(_SC("GetCrouchEnabled"), GetCrouchEnabled, 1, _SC("t"));
}
