...
public:
		...
		m_standingOn()
	{
		...
		m_rgb.r = 255; m_rgb.g = 255; m_rgb.b = 255;
	}
	~CPlayer() { delete pos; }
...
public:
	...
	void SetBleeding(bool b);
	void SetDrunkVisuals(int v);
	void SetDrunkHandling(int h);
...
public:
	...
	void Eject();
	void LaySpike();
	void SetCameraPos(Vector pos, Vector look, int interpTimeMS = 0);
