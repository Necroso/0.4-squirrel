...
void SetTimeRate(unsigned int timeRate) {
    functions->SetTimeRate(timeRate);
}
...
void SetWaterLevel(float waterLevel) {
    functions->SetWaterLevel(waterLevel);
}
void SetMaxHeight(float maxHeight) {
    functions->SetMaximumFlightAltitude(maxHeight);
}
...
void ToggleDisableDriveby(bool toggle) {
    functions->SetServerOption(vcmpServerOptionDisableDriveBy, (toggle ? 0 : 1));
}
...
void PlayGameSound(int world, int sound, Vector* pos) {
...
CPickup* FindPickup(int id) {
    return pCore->RetrievePickup(id);
}
CObject* FindObject(int id) {
    return pCore->RetrieveObject(id);
}
CVehicle* FindVehicle(int id) {
    return pCore->RetrieveVehicle(id);
}
CCheckpoint* FindCheckpoint(int id) {
    return pCore->RetrieveCheckpoint(id);
}
...
void ShowMapObject(int nModelId, float x, float y, float z) {
    int x2 = (int)(floor(x * 10.0f) + 0.0f);
    int y2 = (int)(floor(y * 10.0f) + 0.0f);
    int z2 = (int)(floor(z * 10.0f) + 0.0f);
...
void Message(const SQChar* message) {
    functions->SendClientMessage(-1, 0x0b5fa5ff, "%s", message);
}
...
void PrivMessage(CPlayer* player,
...
void SendPlayerMessage(CPlayer* playerToFake, CPlayer* playerTo,
    const SQChar* message) {
...
const SQChar* GetWeaponName(int weaponID) {
    ...
    case 0:
        return _SC("Unarmed");
    case 1:
        return _SC("Brass Knuckles");
    case 2:
        return _SC("Screwdriver");
    case 3:
        return _SC("Golf Club");
    case 4:
        return _SC("Nightstick");
    case 5:
        return _SC("Knife");
    case 6:
        return _SC("Baseball Bat");
    case 7:
        return _SC("Hammer");
    case 8:
        return _SC("Meat Cleaver");
    case 9:
        return _SC("Machete");
    case 10:
        return _SC("Katana");
    ...
    case 12:
        return _SC("Grenade");
    case 13:
        return _SC("Remote Detonation Grenade");
    case 14:
        return _SC("Tear Gas");
    case 15:
        return _SC("Molotov Cocktails");
    case 16:
        return _SC("Rocket");
    case 17:
        return _SC("Colt .45");
    case 18:
        return _SC("Python");
    case 19:
        return _SC("Pump-Action Shotgun");
    case 20:
        return _SC("SPAS-12 Shotgun");
    case 21:
        return _SC("Stubby Shotgun");
    case 22:
        return _SC("TEC-9");
    case 23:
        return _SC("Uzi");
    case 24:
        return _SC("Silenced Ingram");
    case 25:
        return _SC("MP5");
    case 26:
        return _SC("M4");
    case 27:
        return _SC("Ruger");
    case 28:
        return _SC("Sniper Rifle");
    case 29:
        return _SC("Laserscope Sniper Rifle");
    case 30:
        return _SC("Rocket Launcher");
    case 31:
        return _SC("Flamethrower");
    case 32:
        return _SC("M60");
    case 33:
        return _SC("Minigun");
    case 34:
        return _SC("Explosion");
    case 35:
        return _SC("Helicannon");
    case 36:
        return _SC("Camera");
    case 39:
        return _SC("Vehicle");
...
const SQChar* GetSkinName(int skinID) {
    ...
    case 4:
        return _SC("Army");
    case 5:
        return _SC("Paramedic");
    case 6:
        return _SC("Firefighter");
    case 7:
        return _SC("Golf Guy #1");
    case 9:
        return _SC("Bum Lady #1");
    case 10:
        return _SC("Bum Lady #2");
    case 11:
        return _SC("Punk #1");
    case 12:
        return _SC("Lawyer");
    case 13:
        return _SC("Spanish Lady #1");
    case 14:
        return _SC("Spanish Lady #2");
    case 15:
        return _SC("Cool Guy #1");
    case 16:
        return _SC("Arabic Guy");
    case 17:
        return _SC("Beach Lady #1");
    case 18:
        return _SC("Beach Lady #2");
    case 19:
        return _SC("Beach Guy #1");
    case 20:
        return _SC("Beach Guy #2");
    case 21:
        return _SC("Office Lady #1");
    case 22:
        return _SC("Waitress #1");
    case 23:
        return _SC("Food Lady");
    case 24:
        return _SC("Prostitute #1");
    case 25:
        return _SC("Bum Lady #3");
    case 26:
        return _SC("Bum Guy #1");
    case 27:
        return _SC("Garbageman #1");
    case 28:
        return _SC("Taxi Driver #1");
    case 29:
        return _SC("Haitian #1");
    case 30:
        return _SC("Criminal #1");
    case 31:
        return _SC("Hood Lady #1");
    case 32:
        return _SC("Granny #1");
    case 33:
        return _SC("Businessman #1");
    case 34:
        return _SC("Church Guy");
    case 35:
        return _SC("Club Lady #1");
    case 36:
        return _SC("Church Lady");
    case 37:
        return _SC("Pimp");
    case 38:
        return _SC("Beach Lady #3");
    case 39:
        return _SC("Beach Guy #3");
    case 40:
        return _SC("Beach Lady #4");
    case 41:
        return _SC("Beach Guy #4");
    case 42:
        return _SC("Businessman #2");
    case 43:
        return _SC("Prostitute #2");
    case 44:
        return _SC("Bum Lady #4");
    case 45:
        return _SC("Bum Guy #2");
    case 46:
        return _SC("Haitian #2");
    case 47:
        return _SC("Construction Worker #1");
    case 48:
        return _SC("Punk #2");
    case 49:
        return _SC("Prostitute #3");
    case 50:
        return _SC("Granny #2");
    case 51:
        return _SC("Punk #3");
    case 52:
        return _SC("Businessman #3");
    case 53:
        return _SC("Spanish Lady #3");
    case 54:
        return _SC("Spanish Lady #4");
    case 55:
        return _SC("Cool Guy #2");
    case 56:
        return _SC("Businessman #4");
    case 57:
        return _SC("Beach Lady #5");
    case 58:
        return _SC("Beach Guy #5");
    case 59:
        return _SC("Beach Lady #6");
    case 60:
        return _SC("Beach Guy #6");
    case 61:
        return _SC("Construction Worker #2");
    case 62:
        return _SC("Golf Guy #2");
    case 63:
        return _SC("Golf Lady");
    case 64:
        return _SC("Golf Guy #3");
    case 65:
        return _SC("Beach Lady #7");
    case 66:
        return _SC("Beach Guy #7");
    case 67:
        return _SC("Office Lady #2");
    case 68:
        return _SC("Businessman #5");
    case 69:
        return _SC("Businessman #6");
    case 70:
        return _SC("Prostitute #4");
    case 71:
        return _SC("Bum Lady #4");
    case 72:
        return _SC("Bum Guy #3");
    case 73:
        return _SC("Spanish Guy");
    case 74:
        return _SC("Taxi Driver #2");
    case 75:
        return _SC("Gym Lady");
    case 76:
        return _SC("Gym Guy");
    case 77:
        return _SC("Skate Lady");
    case 78:
        return _SC("Skate Guy");
    case 79:
        return _SC("Shopper #1");
    case 80:
        return _SC("Shopper #2");
    case 81:
        return _SC("Tourist #1");
    case 82:
        return _SC("Tourist #2");
    case 83:
        return _SC("Cuban #1");
    case 84:
        return _SC("Cuban #2");
    case 85:
        return _SC("Haitian #3");
    case 86:
        return _SC("Haitian #4");
    case 87:
        return _SC("Shark #1");
    case 88:
        return _SC("Shark #2");
    case 89:
        return _SC("Diaz Guy #1");
    case 90:
        return _SC("Diaz Guy #2");
    case 91:
        return _SC("DBP Security #1");
    case 92:
        return _SC("DBP Security #2");
    case 93:
        return _SC("Biker #1");
    case 94:
        return _SC("Biker #2");
    case 95:
        return _SC("Vercetti Guy #1");
    case 96:
        return _SC("Vercetti Guy #2");
    case 97:
        return _SC("Undercover Cop #1");
    case 98:
        return _SC("Undercover Cop #2");
    case 99:
        return _SC("Undercover Cop #3");
    case 100:
        return _SC("Undercover Cop #4");
    case 101:
        return _SC("Undercover Cop #5");
    case 102:
        return _SC("Undercover Cop #6");
    case 103:
        return _SC("Rich Guy");
    case 104:
        return _SC("Cool Guy #3");
    case 105:
        return _SC("Prostitute #5");
    case 106:
        return _SC("Prostitute #6");
    case 107:
        return _SC("Ricardo Diaz");
    case 108:
        return _SC("Love Fist #1");
    case 109:
        return _SC("Ken Rosenburg");
    case 110:
        return _SC("Candy Suxx");
    case 111:
        return _SC("Hilary");
    case 112:
        return _SC("Love Fist #2");
    case 113:
        return _SC("Phil");
    case 114:
        return _SC("Rockstar Guy");
    case 115:
        return _SC("Sonny");
    case 116:
        return _SC("Lance");
    case 117:
        return _SC("Mercedes");
    case 118:
        return _SC("Love Fist #3");
    case 119:
        return _SC("Alex Shrub");
    case 120:
        return _SC("Lance (Cop)");
    case 121:
        return _SC("Lance");
    case 122:
        return _SC("Cortez");
    case 123:
        return _SC("GIGN Agent");
    case 124:
        return _SC("Gonzalez");
    case 125:
        return _SC("Hilary (Robber)");
    case 126:
        return _SC("Mercedes");
    case 127:
        return _SC("Cam");
    case 128:
        return _SC("Cam (Robber)");
    case 129:
        return _SC("Phil (One Arm)");
    case 130:
        return _SC("Phil (Robber)");
    case 131:
        return _SC("Cool Guy #4");
    case 132:
        return _SC("Pizza Man");
    case 133:
        return _SC("Taxi Driver #1");
    case 134:
        return _SC("Taxi Driver #2");
    ...
    case 138:
        return _SC("Chef");
    case 139:
        return _SC("Criminal #2");
    case 140:
        return _SC("French Guy");
    case 141:
        return _SC("Garbageman #2");
    case 142:
        return _SC("Haitian #5");
    case 143:
        return _SC("Waitress #2");
    case 144:
        return _SC("Sonny Guy #1");
    case 145:
        return _SC("Sonny Guy #2");
    case 146:
        return _SC("Sonny Guy #3");
    case 147:
        return _SC("Columbian Guy #2");
    case 148:
        return _SC("Haitian #6");
    case 149:
        return _SC("Beach Guy #8");
    case 150:
        return _SC("Garbageman #3");
    case 151:
        return _SC("Garbageman #4");
    case 152:
        return _SC("Garbageman #5");
    case 153:
        return _SC("Tranny");
    case 154:
        return _SC("Thug #5");
    case 155:
        return _SC("SpandEx Guy #1");
    case 156:
        return _SC("SpandEx Guy #2");
    case 157:
        return _SC("Stripper #1");
    case 158:
        return _SC("Stripper #2");
    case 159:
        return _SC("Stripper #3");
    case 160:
        return _SC("Store Clerk");
    case 161:
        return _SC("Tommy Vercetti");
    case 162:
        return _SC("Soiree Outfit");
    case 163:
        return _SC("Coveralls Outfit");
    case 164:
        return _SC("Country Club Outfit");
    case 165:
        return _SC("Havana Outfit");
    case 166:
        return _SC("Cop Outfit");
    case 167:
        return _SC("Bank Job Outfit");
    case 168:
        return _SC("Casual Outfit");
    case 169:
        return _SC("Mr. Vercetti Outfit");
    case 170:
        return _SC("Tracksuit #1");
    case 171:
        return _SC("Tracksuit #2");
    case 172:
        return _SC("Cool Guy #5");
    case 173:
        return _SC("Cool Guy #6");
    case 174:
        return _SC("Prostitute #7");
    case 175:
        return _SC("Sonny Guy #4");
    case 176:
        return _SC("Prostitute #8");
    case 177:
        return _SC("Club Lady #2");
    case 178:
        return _SC("Prostitute #9");
    case 179:
        return _SC("Haitian #7");
    case 180:
        return _SC("Frankie Outfit");
    case 181:
        return _SC("Sonny Guy #5");
    case 182:
        return _SC("Columbian Guy #3");
    case 183:
        return _SC("Hood Lady #2");
    case 184:
        return _SC("Punk #4");
    case 185:
        return _SC("Waitress #3");
    case 186:
        return _SC("Kent Paul");
    default:
        return NULL;
    }
}
...
const SQChar* GetVehicleNameFromModel(int model) {
    switch (model) {
    case 130:
        return _SC("Landstalker");
    case 131:
        return _SC("Idaho");
    case 132:
        return _SC("Stinger");
    case 133:
        return _SC("Linerunner");
    case 134:
        return _SC("Perennial");
    case 135:
        return _SC("Sentinel");
    case 136:
        return _SC("Rio");
    case 137:
        return _SC("Firetruck");
    case 138:
        return _SC("Trashmaster");
    case 139:
        return _SC("Stretch");
    case 140:
        return _SC("Manana");
    ...
    case 145:
        return _SC("Cheetah");
    case 146:
        return _SC("Ambulance");
    case 147:
        return _SC("FBI Washington");
    case 148:
        return _SC("Moonbeam");
    case 149:
        return _SC("Esperanto");
    case 150:
        return _SC("Taxi");
    case 151:
        return _SC("Washington");
    case 152:
        return _SC("Bobcat");
    case 153:
        return _SC("Mr. Whoopee");
    case 154:
        return _SC("BF Injection");
    case 155:
        return _SC("Hunter");
    case 156:
        return _SC("Police");
    ...
    case 162:
        return _SC("Rhino");
    case 163:
        return _SC("Barracks OL");
    case 164:
        return _SC("Cuban Hermes");
    case 165:
        return _SC("Helicopter");
    case 166:
        return _SC("Angel");
    case 167:
        return _SC("Coach");
    ...
    case 170:
        return _SC("Rumpo");
    case 171:
        return _SC("RC Bandit");
    case 172:
        return _SC("Romero's Hearse");
    case 173:
        return _SC("Packer");
    case 174:
        return _SC("Sentinel XS");
    case 175:
        return _SC("Admiral");
    case 176:
        return _SC("Squalo");
    case 177:
        return _SC("Sea Sparrow");
    case 178:
        return _SC("Pizza Boy");
    case 179:
        return _SC("Gang Burrito");
    case 180:
        return _SC("Airtrain");
    case 181:
        return _SC("Deaddodo");
    ...
    case 212:
        return _SC("Burrito");
    case 213:
        return _SC("Spand Express");
    case 214:
        return _SC("Marquis");
    case 215:
        return _SC("Baggage Handler");
    case 216:
        return _SC("Kaufman Cab");
    case 217:
        return _SC("Maverick");
    case 218:
        return _SC("VCN Maverick");
    case 219:
        return _SC("Rancher");
    case 220:
        return _SC("FBI Rancher");
    case 221:
        return _SC("Virgo");
    case 222:
        return _SC("Greenwood");
    case 223:
        return _SC("Cuban Jetmax");
    case 224:
        return _SC("Hotring Racer #1");
    case 225:
        return _SC("Sandking");
    case 226:
        return _SC("Blista Compact");
    case 227:
        return _SC("Police Maverick");
    case 228:
        return _SC("Boxville");
    case 229:
        return _SC("Benson");
    case 230:
        return _SC("Mesa Grande");
    case 231:
        return _SC("RC Goblin");
    case 232:
        return _SC("Hotring Racer #2");
    case 233:
        return _SC("Hotring Racer #3");
    case 234:
        return _SC("Bloodring Banger #1");
    case 235:
        return _SC("Bloodring Banger #2");
    case 236:
        return _SC("Vice Squad Cheetah");
    default:
        return NULL;
    }
}
...
int CreateRadioStream(const char* radioName,
    const char* radioURL, bool bCanSelect) {
    return functions->AddRadioStream(-1, radioName, radioURL, bCanSelect);
}
void CreateRadioStreamWithID(int streamID,
...
SQInteger release_hook(SQUserPointer p, SQInteger size) {
    return 1;
}
...
inline size_t Internal_NumTok(const char* szText,
...
inline bool Internal_InPoly(float fX, float fY,
    const unsigned int uiPoints,
    const AreaPoints fPoints[]) {
...
SQInteger NewTimer(HSQUIRRELVM v) {
    ...
    case OT_INTEGER: {
        SQInteger value;
        if (SQ_FAILED(sq_getinteger(v, 3, &value)))
            return sq_throwerror(v, _SC("Failed to read interval."));

        fInterval = static_cast <SQFloat> (value);
        break;
    }

    case OT_FLOAT: {
        if (SQ_FAILED(sq_getfloat(v, 3, &fInterval)))
            return sq_throwerror(v, _SC("Failed to read interval."));
        break;
    }
    ...
    if (fInterval <= 0.0f)
        return sq_throwerror(v, _SC("Argument 2: Interval must be greater than zero."));

    if (sq_gettype(v, 4) != OT_INTEGER)
        return sq_throwerror(v, _SC("Argument 3: Repeats must be an integer."));

    SQInteger maxPulses;
    if (SQ_FAILED(sq_getinteger(v, 4, &maxPulses)))
        return sq_throwerror(v, _SC("Failed to read repeats."));

    if (maxPulses < 0)
        return sq_throwerror(v, _SC("Argument 3: Repeats must be >= 0 (0 = infinite)."));
    ...
    SQObjectType funcType = static_cast <SQObjectType>(funcObj.GetType());
    if (funcType != OT_CLOSURE && funcType != OT_NATIVECLOSURE)
        return sq_throwerror(v, _SC("The given timer callback is not a function."));
    ...
    for (SQInteger i = 5; i <= top; ++i) {
        ...
        if (SQ_SUCCEEDED(sq_getstackobj(v, i, &obj)))
            pTimer->params.emplace_back(obj, v);
    }

    Sqrat::ClassType < CTimer > ::PushInstance(v, pTimer);
    sq_setreleasehook(v, -1, &CTimer::ReleaseHook);

    HSQOBJECT timerInstance;
    sq_resetobject(&timerInstance);

    if (SQ_FAILED(sq_getstackobj(v, -1, &timerInstance))) {
        delete pTimer;
        return sq_throwerror(v, _SC("Failed to create timer instance."));
    }

    Sqrat::Object timerHandle(timerInstance, v);
...
std::string ReplaceChars(const SQChar* original, Sqrat::Object target, const SQChar* newChar) {
    ...
    for (const std::string& targetStr : targets) {
        if (targetStr.empty())
            continue;

        for (size_t pos = 0; pos + targetStr.length() <= text.length();) {
            bool match = true;

            for (size_t i = 0; i < targetStr.length(); ++i) {
                if (std::tolower(static_cast <unsigned char>(text[pos + i])) !=
                    std::tolower(static_cast <unsigned char>(targetStr[i]))) {
                    match = false;
                    break;
                }
            }
            ...
            if (match) {
                text.replace(pos, targetStr.length(),
                    std::string(targetStr.length(), replacementChar[0]));
...
void SetVehiclesForcedRespawnHeight(SQFloat height) {
    functions->SetVehiclesForcedRespawnHeight(height);
}
SQFloat GetVehiclesForcedRespawnHeight(void) {
    return functions->GetVehiclesForcedRespawnHeight();
}
...
SQInteger SetAmmuWeapon(HSQUIRRELVM v) {
    OutputWarning("SetAmmuWeapon does not exist in 0.4. Ammunations must be scripted.");
    return 0;
}
SQInteger IsAmmuWeaponEnabled(HSQUIRRELVM v) {
    OutputWarning("IsAmmuWeaponEnabled does not exist in 0.4. Ammunations must be scripted.");
    sq->pushbool(v, false);
    return 1;
}
SQInteger SetAmmuWeaponEnabled(HSQUIRRELVM v) {
    OutputWarning("SetAmmuWeaponEnabled does not exist in 0.4. Ammunations must be scripted.");
    return 0;
}
...
void SetFallEnabled(bool unused) {
    OutputWarning("SetFallEnabled has no effect.");
}
...
void SetWeatherLock(bool isLocked) {
    OutputWarning("SetWeatherLock has no effect.");
}
...
void SetMapName(const SQChar* mapName) {
    OutputWarning("SetMapName has no effect.");
}
